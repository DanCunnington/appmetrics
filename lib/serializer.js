...
/*
 * Allow objects with circularities to be flattened/serialized. This is achieved
 * by replacing references to already seen objects with 'CIRCULAR-' + id
 */
var CIRCULAR = 'CIRCULAR-';

exports.serialize =
    function(obj, objCache, id) {
      var newObj = {};
          ...
          if (typeof (obj[prop]) === 'object' && obj[prop] !== null) {
            ...
            if (Array.isArray(obj[prop])) {
              if (obj[prop].length === 0) {
                ...
                for (var idx = 0; idx < obj[prop].length; idx++) {
                  ...
                  if (id > -1) {
                    ...
                    newObj[prop][idx] =
                        exports.serialize(obj[prop][idx], objCache, objCache
                            .indexOf(obj[prop][idx]));
                  }
                }
              }
              ...
              if (id > -1) {
                ...
                newObj[prop] =
                    exports.serialize(obj[prop], objCache, objCache
                        .indexOf(obj[prop]));
              }
            }
          } else {
...
/*
 * Reverse the serialization, inflating CIRCULAR + id to a reference to the
 * object
 */
