...
// This method attaches our probe to the instance of the postgres module
// (target)
PostgresProbe.prototype.attach =
      ...
      aspect.before(target, 'connect', function(
        ...
        if (aspect.findCallbackArg(methodArgs) !== undefined) {
          aspect.aroundCallback(methodArgs, probeData, function(
            ...
            // so only monitor queries on this client if we haven't seen it
            // before
      ...
      aspect.aroundCallback(methodArgs, probeData, function(
        ...
        if (typeof (callbackPosition) !== 'undefined') {
          aspect.strongTraceTransactionLink(
              'pg: ', method, methodArgs[callbackPosition]);
        }
 ...
 *
 * These provide: time: time event started query: The SQL executed duration: the
 ...
 */
PostgresProbe.prototype.requestStart =
    function(probeData, target, method, methodArgs) {
      probeData.req =
          request.startRequest('DB', 'query', false, probeData.timer);
