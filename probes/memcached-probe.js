...
MemcachedProbe.prototype.attach =
    function(name, target) {
      ...
      aspect.around(target.prototype, methods, function(
        ...
        aspect.aroundCallback(methodArgs, context, function(
          ...
          if (typeof (callbackPosition) !== 'undefined') {
            aspect.strongTraceTransactionLink(
                'memcached: ', methodName, methodArgs[callbackPosition]);
          }
 ...
 *
 * These provide: time: time event started method: the API method/function being
 * used key: The data key being used duration: the time for the request to
 * respond
 */
 ...
 */
MemcachedProbe.prototype.requestStart =
    function(context, methodName, methodArgs) {
      context.req =
          request.startRequest('Memcached', methodName, false, context.timer);
    };

MemcachedProbe.prototype.requestEnd =
    function(context, methodName, methodArgs) {
      context.req.stop({
        key: methodArgs[0]
      });
