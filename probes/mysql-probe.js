...
MySqlProbe.prototype.attach =
    function(name, target) {
      ...
      aspect.after(target, 'createConnection', data, function(
          target, methodName, args, probeData, rc) {
        aspect.before(rc, 'query', function(
          ...
          if (aspect.findCallbackArg(methodArgs) !== undefined) {
            aspect.aroundCallback(
                methodArgs, probeData, function(target, args) {
                  ...
                  if (typeof (callbackPosition) !== 'undefined') {
                    aspect.strongTraceTransactionLink(
                        'mysql: ', method, methodArgs[callbackPosition]);
                  }
...
MySqlProbe.prototype.requestEnd = function(probeData, method, methodArgs) {
  probeData.req.stop({
    sql: JSON.stringify(methodArgs[0])
  });
};
