...
OracleDBProbe.prototype.attach =
    function(name, target) {
      ...
      aspect.before(target, 'createPool', function(
          target, methodName, args, context) {
        aspect.aroundCallback(args, {}, function(
            target, callbackArgs, probeData) {
          var err = callbackArgs[0];
          if (!err) {
    ...
    aspect.aroundCallback(args, probeData, function(
      ...
      if (typeof (callbackPosition) !== 'undefined') {
        aspect.strongTraceTransactionLink(
            'oracledb: ', methodName, args[callbackPosition]);
      }
 ...
 */
OracleDBProbe.prototype.requestStart =
    function(probeData, method, methodArgs) {
      probeData.req =
          request.startRequest('OracleDB', method, false, probeData.timer);
    };
