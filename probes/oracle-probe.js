        ...
        aspect.aroundCallback(args, {}, function(
          ...
          if (!err) {
            ...
            aspect.after(connection, 'prepare', function(
                target, methodName, arguments, context, ret) {
    ...
    aspect.aroundCallback(args, probeData, function(
      ...
      if (typeof (callbackPosition) !== 'undefined') {
        aspect.strongTraceTransactionLink(
            'oracle: ', methodName, args[callbackPosition]);
      }
 ...
 */
OracleProbe.prototype.requestStart =
    function(probeData, method, methodArgs) {
      probeData.req =
          request.startRequest('Oracle', method, false, probeData.timer);
    };
